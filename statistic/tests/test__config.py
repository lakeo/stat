# stat/server/tests/test_config.py
...
class TestTestingConfig(TestCase):
    ...
    def create_app(self):
        app.config.from_object('statistic.server.config.TestingConfig')
        return app
...
class TestProductionConfig(TestCase):
    ...
    def create_app(self):
        app.config.from_object('statistic.server.config.ProductionConfig')
        return app
